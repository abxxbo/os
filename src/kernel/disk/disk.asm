;; CODE ADAPTED FROM leo007er1/MascOS

FATLoc equ 0x50
RootDirMemLoc equ 0x170
KernOff equ 4096 ;; 8 sectors
...
ReadAttempts: db 0
ReadDiskErrorMessage: db `[someos] failed to read\r\n`, 0